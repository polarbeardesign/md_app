...
set :user, 'marshall'
set :domain, 'marshallingdetachment.org'

set :application, "caf_md_app"
set :repository,  "git@github.com:polarbeardesign/md_app.git"
set :scm, 'git'
set :branch, "master"
...
after "deploy:restart", "deploy:cleanup", "deploy:symlink_env_file", "deploy:symlink_uploads", "deploy:symlink_htaccess_file", "deploy:symlink_uploads", "deploy:precompile_other"
